  ...
  return (
    <>
      ...
      <Link
        ...
        className="mb-2 inline-block text-base text-dark hover:text-primary text-gray dark:hover:text-primary"
      >
        Forgot Password?
      </Link>
      <p className="text-body-secondary text-gray ">
        <span className="text-gray">Not a member yet?</span>{" "}

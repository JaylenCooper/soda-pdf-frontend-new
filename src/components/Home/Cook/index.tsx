            ...
            <div className="container mx-auto lg:max-w-screen-xl md:max-w-screen-md">
                ...
                <div className='grid grid-cols-1 lg:grid-cols-12 my-16 space-x-5'>
                    <div className='col-span-6 flex justify-start'>
                        <Image src="/images/Cook/ai-tools-en.png" className='rounded-[50px]' alt="nothing" width={600} height={436} />
                    </div>
                    <div className='col-span-6 flex flex-col justify-center'>
                        ...
                        <button className='text-xl font-medium rounded-full text-white py-5 px-6 bg-primary lg:px-10 mr-6 w-fit border border-primary hover:bg-transparent hover:text-primary transition-all duration-300 ease-in-out hover:scale-105 active:scale-95'>Learn more</button>
                    </div>
                </div>
            </div>
        </section >
